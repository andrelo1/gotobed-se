...
namespace Gotobed::Misc
{
	void Init()
	{
		...
		//REL::safe_write(REL::ID(38871).address() + 0x01C7, (std::uint8_t)0xEB);
		//REL::safe_write(REL::ID(36644).address() + 0x01C3, (std::uint8_t)0xEB);
		//REL::safe_write(REL::ID(38317).address() + 0x017F, (std::uint8_t)0xEB);
